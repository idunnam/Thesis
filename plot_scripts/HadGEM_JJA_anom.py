...
#cloud
#list_var_preprocess = ['MSK', 'TT','CC', 'COD', 'SF', 'RF', 'LON', 'LAT','CU', 'CD', 'CM', 'ZZP', 'VVP', 'UUP', 'TTP','ME','SH'] 
...
#HADGEM_anomaly.to_netcdf('/projects/NS9600K/idunnam/src/SEB_anomalies_seasonal/HADGEM_anomaly_JJA.nc')

#HADGEM_anomaly.to_netcdf('/projects/NS9600K/idunnam/src/SEB_anomalies_seasonal/HADGEM_anomaly_JJA_cloud.nc')

HADGEM_anomaly.to_netcdf('/projects/NS9600K/idunnam/src/SEB_anomalies_seasonal/HADGEM_anomaly_JJA_SMB.nc')
