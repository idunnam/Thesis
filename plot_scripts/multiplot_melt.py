...
fig.savefig('/projects/NS9600K/idunnam/Thesis/src/Figures/4_deg_spatial_plots/'+str(TAS)+'_'+season+'_deg_SMB_multiplot.png')
...
fig.savefig('/projects/NS9600K/idunnam/Thesis/src/Figures/4_deg_spatial_plots/'+str(TAS)+'_'+season+'_deg_SMB_diff_multiplot.pdf',bbox_inches='tight',dpi=300)
