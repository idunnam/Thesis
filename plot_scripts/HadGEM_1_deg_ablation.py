...
from ablation_JJA_calculation import mask_ablation_ACCESS,   mask_ablation_CSIRO,   mask_ablation_IPSL, mask_ablation_MIROC5, mask_ablation_NORESM, mask_ablation_CESM, mask_ablation_CNRM_CM6, mask_ablation_CNRM_ESM2,  mask_ablation_MRI, mask_ablation_UKMO
...
mask_ablation_HADGEM = ref_HADGEM.where(ref_HADGEM.SMB < 0)*mymask_test
...
#HADGEM_anomaly = HADGEM_anomaly.where(mask_ablation_HADGEM.SMB < 0, drop=False)
"""

mean_mask = (mask_ablation_ACCESS + mask_ablation_HADGEM + mask_ablation_CSIRO  + mask_ablation_IPSL + mask_ablation_MIROC5
            + mask_ablation_NORESM
            +mask_ablation_CESM + mask_ablation_CNRM_CM6 + mask_ablation_CNRM_ESM2 +  mask_ablation_MRI 
             + mask_ablation_UKMO)/11
"""
HADGEM_anomaly = HADGEM_anomaly.where(mask_ablation_HADGEM.SMB < 0, drop=False)

#HADGEM_anomaly.to_netcdf('/projects/NS9600K/idunnam/src/ablation_JJA/HADGEM_anomaly_ablation_JJA.nc')
