"""
This code is usef for creating new netCDF files for each model in which include seasonal means of COD, CC and TT, calculated from monthly MAR output data of 6 CMIP5 models and 5 CMIP6 models.
"""
# import packages
import xarray as xr
import numpy as np
...
# CMIP5
ACCESS_anomaly.to_netcdf('ACCESS_COD_JJA.nc')
HADGEM_anomaly.to_netcdf('HADGEM_COD_JJA.nc')
CSIRO_anomaly.to_netcdf('CSIRO_COD_JJA.nc')
IPSL_anomaly.to_netcdf('IPSL_COD_JJA.nc')
MIROC5_anomaly.to_netcdf('MIROC5_COD_JJA.nc')
NORESM_anomaly.to_netcdf('NORESM_COD_JJA.nc')


#CMIP6
CESM_anomaly.to_netcdf('CESM_COD_JJA.nc')
CNRM_CM6_anomaly.to_netcdf('CNRM_CM6_COD_JJA.nc')
CNRM_ESM2_anomaly.to_netcdf('CNRM_ESM2_COD_JJA.nc')
MRI_anomaly.to_netcdf('MRI_COD_JJA.nc')
UKMO_anomaly.to_netcdf('UKMO_COD_JJA.nc')